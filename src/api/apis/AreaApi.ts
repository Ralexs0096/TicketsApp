...
export class AreaApi extends runtime.BaseAPI {
   ...
   */
  async createAreaRaw(
    requestParameters: CreateAreaRequest,
   ...
   */
  async deleteAreaRaw(
    requestParameters: DeleteAreaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Area>> {
   ...
   * Fetch All Areas
   */
  async fetchAllAreasRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<FetchAllAreasReply>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FetchAllAreasReplyFromJSON(jsonValue)
    );
  }
   ...
   */
  async updateAreaRaw(
    requestParameters: UpdateAreaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Area>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
